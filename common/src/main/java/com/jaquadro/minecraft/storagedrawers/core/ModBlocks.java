...
public final class ModBlocks
{
    ...
    static ResourceLocation modLoc (String name) {
        return new ResourceLocation(ModConstants.MOD_ID, name);
    }
    ...
    static RegistryEntry<BlockSlave> registerControllerSlaveBlock(String name) {
        return BLOCKS.register(name, () -> new BlockSlave(getStoneBlockProperties()));
    }
    ...
    public static Stream<BlockSlave> getControllerIOs () {
